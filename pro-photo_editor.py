...
class MainWindow(QMainWindow):
    ...
    def createAction(self):
        ...
        self.quit_act = QAction(QIcon("images/exit.png"), "Exit")
    ...
    def createMenu(self):
        ...
        self.menuBar().setNativeMenuBar(False)       # Mac Os
        ...
        # create View menu add actions
        view_menu = self.menuBar().addMenu("Views")
        view_menu.addAction(self.toggle_dock_act)

    def createToolsDockWidget(self):
        """Create the application's dock widget. Use View Edit Image Tools menu to show/hide the dock."""
        ...
        # create QWidget that acts as container and
    ...
    def openImage(self):
        ...
        image_file, _ = QFileDialog.getOpenFileName(self, "Open Image", "", "JPG Files (*.jpeg *.jpg);;PNG Files ("
                                                                            "*.png);;Bitmap Files (*.bmp);;GIF Files "
                                                                            "(*.gif)")
        if image_file:
    ...
    def saveImage(self):
        ...
        image_file, _ = QFileDialog.getSaveFileName(self, "Save Image", "", "JPG Files (*.jpeg *.jpg);;PNG Files ("
                                                                            "*.png);; Bitmap Files (*.bmp);;GIF Files "
                                                                            "(*.gif)")
    ...
    def printImage(self):
        ...
        if print_dialog.exec() == QDialog.DialogCode.Accepted:
            ...
            # Create QRect object to hold the painter's current viewport, which is the image_label
            ...
            # scaled image_label to fit the rect source (0, 0)
